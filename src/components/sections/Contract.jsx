...
export const Contact = () => {
  return (
    <section
      id="contact"
      className="flex flex-col justify-center items-center py-20 px-4 sm:px-6 lg:px-8"
    >
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">
            Contact Me
          </h2>
          ...
          <div className="flex flex-col items-center space-y-6">
            <a href="mailto:thanyavat.book@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors flex items-center space-x-3 text-lg sm:text-xl lg:text-2xl">
              <FaEnvelope size={30} />
          ...
          <p className="text-gray-400 mt-8 text-base sm:text-lg">
